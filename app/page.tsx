  ...
  return (
    <section>
      <h1 className=" mx-auto text-left font-medium text-4xl mb-4 text-slate-950 md:w=1/2 lg:w-1/2 xl:w-2/5 2xl:w-1/4  ">
        ...
        <p className="text-slate-800 text-lg md:text-xl leading-normal mx-auto text-left font-normal  mb-4  md:w=1/2 lg:w-1/2 xl:w-2/5 2xl:w-1/4">
        ...
        <Link
          href="/info"
          className="group bg-slate-950 hover:bg-slate-800 transition-colors mt-8 font-mono text-xs font-semibold rounded-full px-8 py-3 text-white mx-auto text-left  "
        >
          More Information{' '}
